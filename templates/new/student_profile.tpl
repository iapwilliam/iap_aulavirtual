                ...
                <div class="col-md-4 stretch-card grid-margin">
                    <div class="card card-img-holder text-white bg-gradient-info">
                        ...
                        <div class="card-body">
                            ...
                            {foreach from=$subject.documentos_digitales item=documento}
                                <br>
                                <a href="{$WEB_ROOT}/pdf/documento-digital.php?alumno={$User.userId}&curso={$subject.courseId}&documento={$documento.id}"
                                    target="_blank" class="btn btn-outline-light btn-fw btn-sm btn-block">
                                    <i class="far fa-list-alt"></i> {$tipoDigital[$documento['tipo']]}
                                </a>
                            {/foreach}
                        </div>
                    </div>
