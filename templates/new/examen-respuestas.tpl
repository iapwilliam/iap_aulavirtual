<div class="row mb-3">
    <div class="col-md-12">
        ...
        <div class="alert alert-info">
            Las respuestas marcadas con color verde son las correctas, si se contestó correctamente solo se muestran las respuestas correctas.
            En caso contrario se mostrará la respuesta correcta y la respuesta incorrecta del estudiante marcada en rojo.
        </div>
                        ...
                        <div class="input-group mb-3 col-md-12 align-items-center form-group">
                            ...
                            {if ($respuesta.answer == "opcionA" && $respuesta.currentAnswer == "opcionA") || ($respuesta.answer == "opcionA" && $respuesta.currentAnswer != "opcionA")}
                                <div class="input-group-text">
                                    <input type="radio" name="answerA{$respuesta.testId}" id="answerA{$respuesta.testId}" class="answerPointer" checked disabled>
                                </div>
                    ...
                    {if $respuesta.opcionB}
                        <div class="input-group mb-3 col-md-12 align-items-center form-group">
                            ...
                            {if ($respuesta.answer == "opcionB" && $respuesta.currentAnswer == "opcionB") || ($respuesta.answer == "opcionB" && $respuesta.currentAnswer != "opcionB")}
                                <div class="input-group-text">
                                    <input type="radio" name="answerB{$respuesta.testId}" id="answerB{$respuesta.testId}" class="answerPointer" checked disabled>
                                </div>
                    ...
                    {if $respuesta.opcionC}
                        <div class="input-group mb-3 col-md-12 align-items-center form-group">
                            ...
                            {if ($respuesta.answer == "opcionC" && $respuesta.currentAnswer == "opcionC") || ($respuesta.answer == "opcionC" && $respuesta.currentAnswer != "opcionC")}
                                <div class="input-group-text">
                                    <input type="radio" name="answerC{$respuesta.testId}" id="answerC{$respuesta.testId}" class="answerPointer" checked disabled>
                                </div>
                    ...
                    {if $respuesta.opcionD}
                        <div class="input-group mb-3 col-md-12 align-items-center form-group">
                            ...
                            {if ($respuesta.answer == "opcionD" && $respuesta.currentAnswer == "opcionD") || ($respuesta.answer == "opcionD" && $respuesta.currentAnswer != "opcionD")}
                                <div class="input-group-text">
                                    <input type="radio" name="answerD{$respuesta.testId}" id="answerD{$respuesta.testId}" class="answerPointer" checked disabled>
                                </div>
                    ...
                    {if $respuesta.opcionE}
                        <div class="input-group mb-3 col-md-12 align-items-center form-group">
                            ...
                            {if ($respuesta.answer == "opcionE" && $respuesta.currentAnswer == "opcionE") || ($respuesta.answer == "opcionE" && $respuesta.currentAnswer != "opcionE")}
                                <div class="input-group-text">
                                    <input type="radio" name="answerE{$respuesta.testId}" id="answerE{$respuesta.testId}" class="answerPointer" checked disabled>
                                </div>
